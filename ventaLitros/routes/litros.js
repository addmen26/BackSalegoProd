...
var Controller = require('../controllers/litros');
...
api.get('/litros/', Controller.getLitros);
api.get('/totalesventas/', Controller.getTotales);
api.get('/totalesventasagrupada/', Controller.getTotalesGrup);
api.get('/totalescategoria/', Controller.getTotalesCategoria);
api.get('/totalesactividad/', Controller.getTotalesActividad);
api.get('/meseslitros/', Controller.getMesesLitros);
api.get('/mesesventas/', Controller.getMesesVentas);
