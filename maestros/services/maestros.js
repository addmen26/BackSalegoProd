...
const base_tipoCliente=require('../../models/tipoCliente');
const base_tipoEmpresa=require('../../models/tipoEmpresa');
const base_sector=require('../../models/sector');
const base_industria=require('../../models/industria');
const base_fuenteCliente=require('../../models/fuenteClientes');
...
async function updateConvocatoria(req) {
    ...
    async function getLitros(req) {
        ...
        try {
            ...
            const data = await sequelize.query(
                `
                SELECT *, SUM(cantidad * litros_kg) AS litros
                FROM ventas,productos where producto=codigo
    ...
    async function getTotalesGrup(req) {
        console.log(req.query)
        let params=req.query.id
        try {
            ...
            const data = await sequelize.query(
                ...
                SELECT *, SUM(cantidad * litros_kg) AS litros,
 SUM(monto) AS venta
  FROM ventas,productos,distribuidor where producto=codigo and id_distribuidor = iddistribuidor
   GROUP BY id_distribuidor;
    ...
    async function getTotalesCategoria(req) {
        console.log(req.query)
        let params=req.query.id
        try {
            ...
            const data = await sequelize.query(
                ...
                SELECT *, SUM(cantidad * litros_kg) AS litros,
                SUM(monto) AS venta
                 FROM ventas,productos where codigo=producto
                  GROUP BY categoria;
                `,
                {
                    replacements: {
    ...
    async function getTotalesActividad(req) {
        console.log(req.query)
        let params=req.query.id
        try {
    ...
    async function getMesesLitros(req) {
        try {
            ...
            const data = await sequelize.query(
                `
                SELECT  
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 1 THEN cantidad * litros_kg ELSE 0 END) AS Ene,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 2 THEN cantidad * litros_kg  ELSE 0 END) AS Feb,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 3 THEN cantidad * litros_kg  ELSE 0 END) AS Mar,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 4 THEN cantidad * litros_kg  ELSE 0 END) AS Abr,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 5 THEN cantidad * litros_kg  ELSE 0 END) AS May,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 6 THEN cantidad * litros_kg  ELSE 0 END) AS Jun,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 7 THEN cantidad * litros_kg  ELSE 0 END) AS Jul,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 8 THEN cantidad * litros_kg  ELSE 0 END) AS Ago,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 9 THEN cantidad * litros_kg  ELSE 0 END) AS Sep, 
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 10 THEN cantidad * litros_kg  ELSE 0 END) AS Oct,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 11 THEN cantidad * litros_kg  ELSE 0 END) AS Nov,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 12 THEN cantidad * litros_kg  ELSE 0 END) AS Dic
                FROM ventas,productos
                WHERE fecha_venta BETWEEN '2022-01-01' AND '4038-12-31' and producto=codigo`,
                {
                    replacements: {
    ...
    async function getMesesVentas(req) {
        try {
            ...
            const data = await sequelize.query(
                `
                SELECT  
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 1 THEN monto ELSE 0 END) AS Ene,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 2 THEN monto   ELSE 0 END) AS Feb,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 3 THEN monto  ELSE 0 END) AS Mar,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 4 THEN monto ELSE 0 END) AS Abr,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 5 THEN monto ELSE 0 END) AS May,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 6 THEN monto ELSE 0 END) AS Jun,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 7 THEN monto  ELSE 0 END) AS Jul,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 8 THEN monto  ELSE 0 END) AS Ago,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 9 THEN monto  ELSE 0 END) AS Sep, 
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 10 THEN monto  ELSE 0 END) AS Oct,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 11 THEN monto ELSE 0 END) AS Nov,
                SUM(CASE WHEN MONTH(ventas.fecha_venta) = 12 THEN monto  ELSE 0 END) AS Dic
                FROM ventas
                WHERE fecha_venta BETWEEN '2022-01-01' AND '4038-12-31' `,
                {
                    replacements: {
...
async function getTipoClientes(req){
    try {
...
async function crearTipoClientes(req) {
    ...
    console.log(req.body);
       ...
       try {
           ...
           data = await base_tipoCliente.create({
   ...
   async function putTipoClientes(req) {
    const params = req.body;
    console.log(params)
    try {
        const data = await base_tipoCliente.update({
            nombre_cliente: params.nombre,
           descripcion: params.descripcion,
           estado:params.estado,
           fecha_modificacion:new Date()
        }, { where: { id_tipoCliente: params.id} });

        if (data === null || data.length < 1) {
            return {
                status: 500,
                error: "Problema al actualizar el Tipocliente.",
                data,
            };
        } else {
            return {
...
async function getTipoEmpresa(req){
    try {
...
async function crearTipoEmpresa(req) {
    ...
    console.log(req.body);
       ...
       try {
           ...
           data = await base_tipoEmpresa.create({
            nombre_tipoempresa:params.nombre,
             descripcion:params.descripcion,
             estado:params.estado,
             fecha_modificacion:new Date(),
             fecha_creacion :new Date()
   ...
   async function putTipoEmpresa(req) {
    const params = req.body;
    console.log(params)
    try {
        const data = await base_tipoEmpresa.update({
            nombre_tipoempresa: params.nombre,
           descripcion: params.descripcion,
           estado:params.estado,
           fecha_modificacion:new Date()
        }, { where: { id_tipoempresa: params.id} });
...
async function crearSectorNuevo(req) {
...
////
async function getIndustria(req){
    try {
...
async function crearIndustria(req) {
    ...
    console.log(req.body);
       ...
       try {
           ...
           data = await base_industria.create({
            nombre_industria:params.nombre,
             descripcion:params.descripcion,
             estado:params.estado,
             fecha_modificacion:new Date(),
             fecha_creacion :new Date()
   ...
   async function putIndustria(req) {
    const params = req.body;
    console.log(params)
    try {
        const data = await base_industria.update({
            nombre_industria: params.nombre,
           descripcion: params.descripcion,
           estado:params.estado,
           fecha_modificacion:new Date()
        }, { where: { id_industria: params.id} });
...
//////
async function getFuenteCliente(req){
    try {
...
async function crearFuenteCliente(req) {
    ...
    console.log(req.body);
       ...
       try {
           ...
           data = await base_fuenteCliente.create({
            nombre_fuente:params.nombre,
             descripcion:params.descripcion,
             estado:params.estado,
             fecha_modificacion:new Date(),
             fecha_creacion :new Date()
   ...
   async function putFuenteCliente(req) {
    const params = req.body;
    console.log(params)
    try {
        const data = await base_industria.update({
           ...
           estado:params.estado,
           fecha_modificacion:new Date()
        }, { where: { id_fuenteCliente: params.id} });
