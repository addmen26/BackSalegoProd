...
var Controller = require('../controllers/maestros');
...
api.get('/tipoClientes/', Controller.getTipoClientes);
...
api.get('/tipoEmpresa/', Controller.getTipoEmpresa);
api.get('/sector/', Controller.getSector);
api.get('/industria/', Controller.getIndustria);
api.get('/fuentecliente/', Controller.getFuenteCliente);
...
// api.get('/preguntasPortal/', Controller.getPreguntasPortal);
 api.post('/creartipocliente/', Controller.crearTipoClientes);
 api.post('/creartipoempresa/', Controller.crearTipoEmpresa);
 api.post('/crearsectornuevo/', Controller. crearSectorNuevo);
 api.post('/crearindustria/', Controller. crearIndustria);
 api.post('/crearfuentecliente/', Controller. crearFuenteCliente);
 api.put('/actulizartipocliente', Controller.putTipoClientes);
api.put('/actulizartipoempresa/', Controller.putTipoEmpresa);
api.put('/actulizarsector/', Controller.putSector);
api.put('/actulizarindustria/', Controller.putIndustria);
api.put('/actulizarfuentecliente/', Controller.putFuenteCliente);
